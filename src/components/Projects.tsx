    ...
    <section id="projects" className="section projects-section">
      <div className="container">
        ...
        >
          ...
          <p className="projects-subtitle">A showcase of unparalleled elegance. Witness how our premium stone transforms spaces into masterpieces.</p>
        </motion.div>
      </div>
          ...
          <div className="marquee-group">
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="projects-overlay glass">
